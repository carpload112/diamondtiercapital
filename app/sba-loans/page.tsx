...
export default function SBALoansPage() {
  return (
    <ServicePageLayout
      title="SBA Loans for Your Business Growth"
      subtitle="Government-backed financing solutions with competitive rates and flexible terms"
      icon={<Building2 className="w-full h-full text-white/90 drop-shadow-lg" />}
